    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Kiểm tra dữ liệu
                if (name.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Vui lòng nhập tên của bạn", Toast.LENGTH_SHORT).show();
                } else if (educationLevel.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Vui lòng chọn hình thức giáo dục", Toast.LENGTH_SHORT).show();
                } else if (favoriteLanguages.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Vui lòng chọn ít nhất 1 ngôn ngữ lập trình", Toast.LENGTH_SHORT).show();
                } else {
